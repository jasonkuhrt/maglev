...
import type { Duration, LocalDate, LocalDateTime } from 'gel'
...
import type { BaseType, getPrimitiveBaseType, RangeType, TypeSet } from './typesystem'
...
import { $nameMapping, literal } from './literal'
import type { $bool, $datetime, $decimal, $duration, $number } from './modules/std'
...
function range<
  ...
  P2 extends
    | orScalarLiteral<
      TypeSet<
        BaseType extends literalToScalarType<P1> ? $anypoint
...
>(
  ...
  // TypeSet<
  RangeType<
    literalToScalarType<P1> extends $anypoint ? literalToScalarType<P1>
      : literalToScalarType<P2> extends $anypoint ? literalToScalarType<P2>
      : $anypoint
  >,
