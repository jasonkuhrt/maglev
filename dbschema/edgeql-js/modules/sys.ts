...
const TransactionAccessMode: $TransactionAccessMode = $.makeType<$TransactionAccessMode>(
  _.spec,
...
const TransactionDeferrability: $TransactionDeferrability = $.makeType<$TransactionDeferrability>(
  _.spec,
...
const TransactionIsolation: $TransactionIsolation = $.makeType<$TransactionIsolation>(
  _.spec,
...
const SystemObject: $.$expr_PathNode<$.TypeSet<$SystemObject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($SystemObject, $.Cardinality.Many),
  null,
)
...
const ExternalObject: $.$expr_PathNode<$.TypeSet<$ExternalObject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ExternalObject, $.Cardinality.Many),
  null,
)

export type $BranchλShape = $.typeutil.flatten<
  $ExternalObjectλShape & _schema.$AnnotationSubjectλShape & {
...
const Branch: $.$expr_PathNode<$.TypeSet<$Branch, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Branch, $.Cardinality.Many),
  null,
)
...
const Database: $.$expr_PathNode<$.TypeSet<$Database, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Database, $.Cardinality.Many),
  null,
)

export type $ExtensionPackageλShape = $.typeutil.flatten<
  $SystemObjectλShape & _schema.$AnnotationSubjectλShape & {
...
const ExtensionPackage: $.$expr_PathNode<$.TypeSet<$ExtensionPackage, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ExtensionPackage, $.Cardinality.Many),
  null,
)
...
const ExtensionPackageMigration: $.$expr_PathNode<$.TypeSet<$ExtensionPackageMigration, $.Cardinality.Many>, null> = _
  .syntax.$PathNode($.$toSet($ExtensionPackageMigration, $.Cardinality.Many), null)
...
const QueryStats: $.$expr_PathNode<$.TypeSet<$QueryStats, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($QueryStats, $.Cardinality.Many),
  null,
)

export type $RoleλShape = $.typeutil.flatten<
  $SystemObjectλShape & _schema.$InheritingObjectλShape & _schema.$AnnotationSubjectλShape & {
    'name': $.PropertyDesc<_std.$str, $.Cardinality.One, true, false, false, false>
...
const Role: $.$expr_PathNode<$.TypeSet<$Role, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Role, $.Cardinality.Many),
  null,
)
    ...
    [
      {
        ...
        namedArgs: {
          ...
          'id': { typeId: '00000000-0000-0000-0000-000000000100', optional: true, setoftype: false, variadic: false },
          'minmax_only': {
