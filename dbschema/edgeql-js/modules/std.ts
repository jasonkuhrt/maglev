...
const bigint: $.scalarTypeWithConstructor<$bigint, never> = $.makeType<$.scalarTypeWithConstructor<$bigint, never>>(
  _.spec,
...
const bool: $.scalarTypeWithConstructor<$bool, never> = $.makeType<$.scalarTypeWithConstructor<$bool, never>>(
  _.spec,
...
const bytes: $.scalarTypeWithConstructor<$bytes, never> = $.makeType<$.scalarTypeWithConstructor<$bytes, never>>(
  _.spec,
...
const decimal: $.scalarTypeWithConstructor<$decimal, never> = $.makeType<$.scalarTypeWithConstructor<$decimal, never>>(
  _.spec,
...
const float32: $.scalarTypeWithConstructor<$number, string> = $.makeType<$.scalarTypeWithConstructor<$number, string>>(
  _.spec,
...
const float64: $.scalarTypeWithConstructor<$number, string> = $.makeType<$.scalarTypeWithConstructor<$number, string>>(
  _.spec,
...
const int16: $.scalarTypeWithConstructor<$number, string> = $.makeType<$.scalarTypeWithConstructor<$number, string>>(
  _.spec,
...
const int32: $.scalarTypeWithConstructor<$number, string> = $.makeType<$.scalarTypeWithConstructor<$number, string>>(
  _.spec,
...
const int64: $.scalarTypeWithConstructor<$number, string> = $.makeType<$.scalarTypeWithConstructor<$number, string>>(
  _.spec,
...
const json: $.scalarTypeWithConstructor<$json, never> = $.makeType<$.scalarTypeWithConstructor<$json, never>>(
  _.spec,
...
const str: $.scalarTypeWithConstructor<$str, never> = $.makeType<$.scalarTypeWithConstructor<$str, never>>(
  _.spec,
...
const uuid: $.scalarTypeWithConstructor<$uuid, never> = $.makeType<$.scalarTypeWithConstructor<$uuid, never>>(
  _.spec,
...
const number: $.scalarTypeWithConstructor<$number, string> = $.makeType<$.scalarTypeWithConstructor<$number, string>>(
  _.spec,
...
const BaseObject: $.$expr_PathNode<$.TypeSet<$BaseObject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
...
type $Object_8ce8c71ee4fa5f73840c22d7eaa58588 = $.ObjectType<
  ...
  'default::DeploymentEvent' | 'default::Project' | 'default::Settings' | 'default::Template'
>
export type $Object = $Object_8ce8c71ee4fa5f73840c22d7eaa58588
const $Object_8ce8c71ee4fa5f73840c22d7eaa58588 = $.makeType<$Object_8ce8c71ee4fa5f73840c22d7eaa58588>(
  _.spec,
...
const Object_8ce8c71ee4fa5f73840c22d7eaa58588: $.$expr_PathNode<
  ...
  null
> = _.syntax.$PathNode($.$toSet($Object_8ce8c71ee4fa5f73840c22d7eaa58588, $.Cardinality.Many), null)

export type $FreeObjectλShape = $.typeutil.flatten<{}>
type $FreeObject = $.ObjectType<'std::FreeObject', $FreeObjectλShape, null, [], 'std::FreeObject'>
const $FreeObject = $.makeType<$FreeObject>(_.spec, '3b741934-07ef-5b95-b7d6-cdc864fd2ae8', _.syntax.literal)

const FreeObject: $.$expr_PathNode<$.TypeSet<$FreeObject, $.Cardinality.One>, null> = _.syntax.$PathNode(
...
function assert_single(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    'std::assert_single',
    args,
    _.spec,
    [
...
function materialized(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      {
        args: [{ typeId: '00000000-0000-0000-0000-000000000001', optional: false, setoftype: false, variadic: false }],
        returnTypeId: '00000000-0000-0000-0000-000000000001',
      },
    ],
  )
...
function min(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      ...
      {
        args: [{ typeId: 'c05958e2-0753-5a63-b7c4-db3626b0d6b5', optional: false, setoftype: true, variadic: false }],
        returnTypeId: 'c05958e2-0753-5a63-b7c4-db3626b0d6b5',
        returnTypemod: 'OptionalType',
        preservesOptionality: true,
      },
      {
        args: [{ typeId: '8571477b-d954-5809-b360-4b1f03253699', optional: false, setoftype: true, variadic: false }],
        returnTypeId: '8571477b-d954-5809-b360-4b1f03253699',
        returnTypemod: 'OptionalType',
        preservesOptionality: true,
      },
      {
        args: [{ typeId: '75ba1b6e-7f51-5c49-b955-e32f20e4f72e', optional: false, setoftype: true, variadic: false }],
        returnTypeId: '75ba1b6e-7f51-5c49-b955-e32f20e4f72e',
        returnTypemod: 'OptionalType',
        preservesOptionality: true,
      },
      {
        args: [{ typeId: 'd50ba716-d5fd-5f69-8afe-9c82fe7436d9', optional: false, setoftype: true, variadic: false }],
        returnTypeId: 'd50ba716-d5fd-5f69-8afe-9c82fe7436d9',
        returnTypemod: 'OptionalType',
        preservesOptionality: true,
      },
      {
        args: [{ typeId: '5b410a6f-a231-524b-8682-4ce2020c1d98', optional: false, setoftype: true, variadic: false }],
...
type enumerateλFuncExpr<
  P1 extends _.castMaps.orScalarLiteral<$.TypeSet<$.BaseType>>,
> = $.$expr_Function<
  $.TupleType<[$int64, $.getPrimitiveBaseType<_.castMaps.literalToTypeSet<P1>['__element__']>]>,
  $.Cardinality.Many
>
/**
...
function contains(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      ...
      {
        args: [{ typeId: 'c38cc584-72e2-5b3d-a9cc-e8e256c2dd0d', optional: false, setoftype: false, variadic: false }, {
      ...
      {
        args: [{ typeId: '74568c88-a8c3-5a02-9acd-64616d07ab8b', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-00000000010c',
          optional: false,
          setoftype: false,
          variadic: false,
...
type array_fillλFuncExpr<
  ...
  P2 extends _.castMaps.orScalarLiteral<$.TypeSet<$number>>,
> = $.$expr_Function<
  $.ArrayType<$.getPrimitiveNonArrayBaseType<_.castMaps.literalToTypeSet<P1>['__element__']>>,
  $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>
>
/**
...
> = $.$expr_Function<
  $.ArrayType<
    _.syntax.getSharedParentPrimitive<
      _.syntax.getSharedParentPrimitive<P1['__element__']['__element__'], P2['__element__']>,
      P3['__element__']
    >
  >,
  $.cardutil.multiplyCardinalities<
...
> = $.$expr_Function<
  $.ArrayType<
    _.syntax.mergeObjectTypes<
      _.syntax.mergeObjectTypes<P1['__element__']['__element__'], P2['__element__']>,
      P3['__element__']
    >
  >,
  $.cardutil.multiplyCardinalities<
...
> = $.$expr_Function<
  _.syntax.getSharedParentPrimitive<
    NamedArgs['default'] extends $.TypeSet ? NamedArgs['default']['__element__'] : undefined,
...
type array_setλFuncExpr<
  ...
  P3 extends $.TypeSet<_stdcal.$relative_durationλICastableTo>,
> = $.$expr_Function<
  $.ArrayType<_.syntax.getSharedParentPrimitive<P1['__element__']['__element__'], P3['__element__']>>,
  $.cardutil.multiplyCardinalities<
    $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>,
    $.cardutil.paramCardinality<P3>
  >
...
type array_setλFuncExpr4<
  ...
  P3 extends $.TypeSet<$.ObjectType>,
> = $.$expr_Function<
  $.ArrayType<_.syntax.mergeObjectTypes<P1['__element__']['__element__'], P3['__element__']>>,
  $.cardutil.multiplyCardinalities<
    $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramCardinality<P2>>,
    $.cardutil.paramCardinality<P3>
  >
...
function array_join(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      {
        args: [{ typeId: 'bb221d39-09f1-507e-8851-62075bb61823', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-000000000101',
          optional: false,
          setoftype: false,
          variadic: false,
      ...
      {
        args: [{ typeId: '48aa45ef-4d93-5fbd-bfb5-81bf67b49eab', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-000000000102',
          optional: false,
          setoftype: false,
          variadic: false,
...
function datetime_get(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      {
        args: [{ typeId: '00000000-0000-0000-0000-00000000010a', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-000000000101',
          optional: false,
          setoftype: false,
          variadic: false,
      ...
      {
        args: [{ typeId: '00000000-0000-0000-0000-00000000010b', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-000000000101',
          optional: false,
          setoftype: false,
          variadic: false,
...
function duration_get(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      ...
      {
        args: [{ typeId: '00000000-0000-0000-0000-000000000112', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-000000000101',
          optional: false,
          setoftype: false,
          variadic: false,
...
> = $.$expr_Function<
  ...
  $.cardutil.overrideLowerBound<
    $.cardutil.multiplyCardinalities<
      $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.paramArrayCardinality<P2>>,
      $.cardutil.optionalParamCardinality<NamedArgs['default']>
    >,
    'Zero'
  >
...
> = $.$expr_Function<
  $str,
  $.cardutil.multiplyCardinalities<$.cardutil.paramCardinality<P1>, $.cardutil.optionalParamCardinality<P2>>
>
/**
...
> = $.$expr_Function<
  $.MultiRangeType<$.getPrimitiveBaseType<P1['__element__']['__element__']['__element__']>>,
  $.cardutil.paramCardinality<P1>
>
function multirange<
  P1 extends $.TypeSet<$.ArrayType<$.RangeType<$anypoint>>>,
...
function range_unpack(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      ...
      {
        args: [{ typeId: 'ef0fdfe1-43f9-5954-b804-56e9b7015ffc', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-0000000001ff',
          optional: false,
          setoftype: false,
          variadic: false,
      ...
      {
        args: [{ typeId: 'b2f8ab6d-ebca-517d-9f16-086423c5bb9c', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-0000000001ff',
          optional: false,
          setoftype: false,
          variadic: false,
      ...
      {
        args: [{ typeId: '10674aaf-8d88-5593-abe9-f7d82be5162b', optional: false, setoftype: false, variadic: false }, {
      ...
      {
        args: [{ typeId: 'c61dd200-697a-5b70-9ff0-6c623a700c14', optional: false, setoftype: false, variadic: false }, {
      ...
      {
        args: [{ typeId: '44825479-8abf-55f6-93bf-572798ec8f12', optional: false, setoftype: false, variadic: false }, {
...
> = $.$expr_Function<
  $.RangeType<_stdcal.$local_datetime>,
  $.Cardinality.Many
>
type multirange_unpackλFuncExpr8<
  P1 extends $.TypeSet<$.MultiRangeType<_stdcal.$local_date>>,
> = $.$expr_Function<
  $.RangeType<_stdcal.$local_date>,
  $.Cardinality.Many
>
...
function multirange_unpack(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      ...
      {
        args: [{ typeId: '37c39ed3-114c-5835-b662-80d80db0199d', optional: false, setoftype: false, variadic: false }],
...
function to_str(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      ...
      {
        args: [{ typeId: '00000000-0000-0000-0000-00000000010c', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-000000000101',
          optional: true,
          setoftype: false,
          variadic: false,
      ...
      {
        args: [{ typeId: '00000000-0000-0000-0000-00000000010d', optional: false, setoftype: false, variadic: false }, {
          typeId: '00000000-0000-0000-0000-000000000101',
          optional: true,
          setoftype: false,
          variadic: false,
...
export type { $anycontiguous, $anydiscrete, $anyfloat, $anyint, $anynumeric, $anypoint, $anyreal, $anyscalar }
