...
const ConnectionTransport: $ConnectionTransport = $.makeType<$ConnectionTransport>(
  _.spec,
...
const memory: $.scalarTypeWithConstructor<$memory, string> = $.makeType<$.scalarTypeWithConstructor<$memory, string>>(
  _.spec,
...
const ConfigObject: $.$expr_PathNode<$.TypeSet<$ConfigObject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ConfigObject, $.Cardinality.Many),
  null,
)
...
const AbstractConfig: $.$expr_PathNode<$.TypeSet<$AbstractConfig, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($AbstractConfig, $.Cardinality.Many),
  null,
)
...
const Auth: $.$expr_PathNode<$.TypeSet<$Auth, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Auth, $.Cardinality.Many),
  null,
)
...
const AuthMethod: $.$expr_PathNode<$.TypeSet<$AuthMethod, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($AuthMethod, $.Cardinality.Many),
  null,
)
...
const DatabaseConfig: $.$expr_PathNode<$.TypeSet<$DatabaseConfig, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($DatabaseConfig, $.Cardinality.Many),
  null,
)
...
const BranchConfig: $.$expr_PathNode<$.TypeSet<$BranchConfig, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($BranchConfig, $.Cardinality.Many),
  null,
)
...
const Config: $.$expr_PathNode<$.TypeSet<$Config, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Config, $.Cardinality.Many),
  null,
)
...
const EmailProviderConfig: $.$expr_PathNode<$.TypeSet<$EmailProviderConfig, $.Cardinality.Many>, null> = _.syntax
  .$PathNode($.$toSet($EmailProviderConfig, $.Cardinality.Many), null)
...
const ExtensionConfig: $.$expr_PathNode<$.TypeSet<$ExtensionConfig, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ExtensionConfig, $.Cardinality.Many),
  null,
)
...
const InstanceConfig: $.$expr_PathNode<$.TypeSet<$InstanceConfig, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($InstanceConfig, $.Cardinality.Many),
  null,
)
...
const JWT: $.$expr_PathNode<$.TypeSet<$JWT, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($JWT, $.Cardinality.Many),
  null,
)
...
const Password: $.$expr_PathNode<$.TypeSet<$Password, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Password, $.Cardinality.Many),
  null,
)
...
const SCRAM: $.$expr_PathNode<$.TypeSet<$SCRAM, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($SCRAM, $.Cardinality.Many),
  null,
)
...
const SMTPProviderConfig: $.$expr_PathNode<$.TypeSet<$SMTPProviderConfig, $.Cardinality.Many>, null> = _.syntax
  .$PathNode($.$toSet($SMTPProviderConfig, $.Cardinality.Many), null)
...
const Trust: $.$expr_PathNode<$.TypeSet<$Trust, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Trust, $.Cardinality.Many),
  null,
)
...
const mTLS: $.$expr_PathNode<$.TypeSet<$mTLS, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($mTLS, $.Cardinality.Many),
  null,
)
