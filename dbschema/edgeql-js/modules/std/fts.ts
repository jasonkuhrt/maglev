...
function search(...args: any[]) {
  const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload(
    ...
    [
      {
        args: [{ typeId: '00000000-0000-0000-0000-000000000003', optional: false, setoftype: false, variadic: false }, {
...
export { document, ElasticLanguage, Language, LuceneLanguage, PGLanguage, Weight }
