...
const date: $.scalarTypeWithConstructor<$date, never> = $.makeType<$.scalarTypeWithConstructor<$date, never>>(
  _.spec,
...
const timestamptz: $.scalarTypeWithConstructor<$timestamptz, never> = $.makeType<
  $.scalarTypeWithConstructor<$timestamptz, never>
>(_.spec, '00000000-0000-0000-0000-000001000002', _.syntax.literal)
