...
const Response: $.$expr_PathNode<$.TypeSet<$Response, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Response, $.Cardinality.Many),
  null,
)
...
export type $ScheduledRequestλShape = $.typeutil.flatten<
  _std.$BaseObjectλShape & {
    ...
    'failure': $.PropertyDesc<
      $.NamedTupleType<{ kind: _stdnet.$RequestFailureKind; message: _std.$str }>,
      $.Cardinality.AtMostOne,
      false,
      false,
      false,
...
const ScheduledRequest: $.$expr_PathNode<$.TypeSet<$ScheduledRequest, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ScheduledRequest, $.Cardinality.Many),
  null,
)
    ...
    [
      {
        ...
        namedArgs: {
          'body': { typeId: '00000000-0000-0000-0000-000000000102', optional: true, setoftype: false, variadic: false },
          'headers': {
...
export { $Response, $ScheduledRequest, Method, Response, ScheduledRequest }
