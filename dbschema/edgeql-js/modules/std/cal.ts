...
const date_duration: $.scalarTypeWithConstructor<$date_duration, string> = $.makeType<
  $.scalarTypeWithConstructor<$date_duration, string>
...
const local_datetime: $.scalarTypeWithConstructor<$local_datetime, string> = $.makeType<
  $.scalarTypeWithConstructor<$local_datetime, string>
>(_.spec, '00000000-0000-0000-0000-00000000010b', _.syntax.literal)
...
const relative_duration: $.scalarTypeWithConstructor<$relative_duration, string> = $.makeType<
  $.scalarTypeWithConstructor<$relative_duration, string>
>(_.spec, '00000000-0000-0000-0000-000000000111', _.syntax.literal)
    ...
    [
      {
        ...
        namedArgs: {
          ...
          'days': { typeId: '00000000-0000-0000-0000-0000000001ff', optional: true, setoftype: false, variadic: false },
          'hours': {
            typeId: '00000000-0000-0000-0000-0000000001ff',
            optional: true,
            setoftype: false,
