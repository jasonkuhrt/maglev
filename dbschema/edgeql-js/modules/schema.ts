...
const MigrationGeneratedBy: $MigrationGeneratedBy = $.makeType<$MigrationGeneratedBy>(
  _.spec,
...
type $Object_32faaa35947553cf88fce68ecf1be4d9 = $.ObjectType<
  ...
  | 'sys::Role'
>
const $Object_32faaa35947553cf88fce68ecf1be4d9 = $.makeType<$Object_32faaa35947553cf88fce68ecf1be4d9>(
  _.spec,
...
const Object_32faaa35947553cf88fce68ecf1be4d9: $.$expr_PathNode<
  ...
  null
> = _.syntax.$PathNode($.$toSet($Object_32faaa35947553cf88fce68ecf1be4d9, $.Cardinality.Many), null)
...
const SubclassableObject: $.$expr_PathNode<$.TypeSet<$SubclassableObject, $.Cardinality.Many>, null> = _.syntax
  .$PathNode($.$toSet($SubclassableObject, $.Cardinality.Many), null)
...
const InheritingObject: $.$expr_PathNode<$.TypeSet<$InheritingObject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($InheritingObject, $.Cardinality.Many),
  null,
)
...
const AnnotationSubject: $.$expr_PathNode<$.TypeSet<$AnnotationSubject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($AnnotationSubject, $.Cardinality.Many),
  null,
)

export type $AccessPolicyλShape = $.typeutil.flatten<
  $InheritingObjectλShape & $AnnotationSubjectλShape & {
...
const AccessPolicy: $.$expr_PathNode<$.TypeSet<$AccessPolicy, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($AccessPolicy, $.Cardinality.Many),
  null,
)
...
const Alias: $.$expr_PathNode<$.TypeSet<$Alias, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Alias, $.Cardinality.Many),
  null,
)
...
const Annotation: $.$expr_PathNode<$.TypeSet<$Annotation, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Annotation, $.Cardinality.Many),
  null,
)

export type $TypeλShape = $.typeutil.flatten<
  $SubclassableObjectλShape & $AnnotationSubjectλShape & {
    'expr': $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>
...
const Type: $.$expr_PathNode<$.TypeSet<$Type, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Type, $.Cardinality.Many),
  null,
)
...
const PrimitiveType: $.$expr_PathNode<$.TypeSet<$PrimitiveType, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($PrimitiveType, $.Cardinality.Many),
  null,
)
...
const CollectionType: $.$expr_PathNode<$.TypeSet<$CollectionType, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($CollectionType, $.Cardinality.Many),
  null,
)
...
const Array: $.$expr_PathNode<$.TypeSet<$Array, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Array, $.Cardinality.Many),
  null,
)
...
const ArrayExprAlias: $.$expr_PathNode<$.TypeSet<$ArrayExprAlias, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ArrayExprAlias, $.Cardinality.Many),
  null,
)
...
const CallableObject: $.$expr_PathNode<$.TypeSet<$CallableObject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($CallableObject, $.Cardinality.Many),
  null,
)
...
const VolatilitySubject: $.$expr_PathNode<$.TypeSet<$VolatilitySubject, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($VolatilitySubject, $.Cardinality.Many),
  null,
)

export type $CastλShape = $.typeutil.flatten<
  $AnnotationSubjectλShape & $VolatilitySubjectλShape & {
...
const Cast: $.$expr_PathNode<$.TypeSet<$Cast, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Cast, $.Cardinality.Many),
  null,
)
...
const ConsistencySubject: $.$expr_PathNode<$.TypeSet<$ConsistencySubject, $.Cardinality.Many>, null> = _.syntax
  .$PathNode($.$toSet($ConsistencySubject, $.Cardinality.Many), null)

export type $ConstraintλShape = $.typeutil.flatten<
  Omit<$CallableObjectλShape, 'params'> & $InheritingObjectλShape & {
    'expr': $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>
...
const Constraint: $.$expr_PathNode<$.TypeSet<$Constraint, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Constraint, $.Cardinality.Many),
  null,
)
...
const Delta: $.$expr_PathNode<$.TypeSet<$Delta, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Delta, $.Cardinality.Many),
  null,
)
...
const Extension: $.$expr_PathNode<$.TypeSet<$Extension, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Extension, $.Cardinality.Many),
  null,
)

export type $FunctionλShape = $.typeutil.flatten<
  $CallableObjectλShape & $VolatilitySubjectλShape & {
...
const Function: $.$expr_PathNode<$.TypeSet<$Function, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Function, $.Cardinality.Many),
  null,
)
...
const FutureBehavior: $.$expr_PathNode<$.TypeSet<$FutureBehavior, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($FutureBehavior, $.Cardinality.Many),
  null,
)
...
const Global: $.$expr_PathNode<$.TypeSet<$Global, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Global, $.Cardinality.Many),
  null,
)
...
const Index: $.$expr_PathNode<$.TypeSet<$Index, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Index, $.Cardinality.Many),
  null,
)

export type $PointerλShape = $.typeutil.flatten<
  Omit<$ConsistencySubjectλShape, '<subject'> & $AnnotationSubjectλShape & {
    'cardinality': $.PropertyDesc<$Cardinality, $.Cardinality.AtMostOne, false, false, false, false>
    'required': $.PropertyDesc<_std.$bool, $.Cardinality.AtMostOne, false, false, false, false>
...
const Pointer: $.$expr_PathNode<$.TypeSet<$Pointer, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Pointer, $.Cardinality.Many),
  null,
)
...
const Source: $.$expr_PathNode<$.TypeSet<$Source, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Source, $.Cardinality.Many),
  null,
)

export type $LinkλShape = $.typeutil.flatten<
  Omit<$PointerλShape, 'target'> & $SourceλShape & {
...
const Link: $.$expr_PathNode<$.TypeSet<$Link, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Link, $.Cardinality.Many),
  null,
)
...
const Migration: $.$expr_PathNode<$.TypeSet<$Migration, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Migration, $.Cardinality.Many),
  null,
)
...
const Module: $.$expr_PathNode<$.TypeSet<$Module, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Module, $.Cardinality.Many),
  null,
)
...
const MultiRange: $.$expr_PathNode<$.TypeSet<$MultiRange, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($MultiRange, $.Cardinality.Many),
  null,
)
...
export type $ObjectTypeλShape = $.typeutil.flatten<
  ...
  & {
    ...
    '<__type__[is Project]': $.LinkDesc<_$default.$Project, $.Cardinality.Many, {}, false, false, false, false>
    '<__type__[is Settings]': $.LinkDesc<_$default.$Settings, $.Cardinality.Many, {}, false, false, false, false>
    '<__type__[is DeploymentEvent]': $.LinkDesc<
      _$default.$DeploymentEvent,
      $.Cardinality.Many,
      {},
      false,
      false,
      ...
      false
    >
    '<__type__[is Template]': $.LinkDesc<_$default.$Template, $.Cardinality.Many, {}, false, false, false, false>
...
const ObjectType: $.$expr_PathNode<$.TypeSet<$ObjectType, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ObjectType, $.Cardinality.Many),
  null,
)
...
const Operator: $.$expr_PathNode<$.TypeSet<$Operator, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Operator, $.Cardinality.Many),
  null,
)
...
const Parameter: $.$expr_PathNode<$.TypeSet<$Parameter, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Parameter, $.Cardinality.Many),
  null,
)
...
const Property: $.$expr_PathNode<$.TypeSet<$Property, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Property, $.Cardinality.Many),
  null,
)
...
const PseudoType: $.$expr_PathNode<$.TypeSet<$PseudoType, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($PseudoType, $.Cardinality.Many),
  null,
)
...
const Range: $.$expr_PathNode<$.TypeSet<$Range, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Range, $.Cardinality.Many),
  null,
)
...
const RangeExprAlias: $.$expr_PathNode<$.TypeSet<$RangeExprAlias, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($RangeExprAlias, $.Cardinality.Many),
  null,
)
...
const Rewrite: $.$expr_PathNode<$.TypeSet<$Rewrite, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Rewrite, $.Cardinality.Many),
  null,
)

export type $ScalarTypeλShape = $.typeutil.flatten<
  $PrimitiveTypeλShape & $ConsistencySubjectλShape & $AnnotationSubjectλShape & {
    'default': $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>
...
const ScalarType: $.$expr_PathNode<$.TypeSet<$ScalarType, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($ScalarType, $.Cardinality.Many),
  null,
)
...
const Trigger: $.$expr_PathNode<$.TypeSet<$Trigger, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Trigger, $.Cardinality.Many),
  null,
)
...
const Tuple: $.$expr_PathNode<$.TypeSet<$Tuple, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($Tuple, $.Cardinality.Many),
  null,
)
...
const TupleElement: $.$expr_PathNode<$.TypeSet<$TupleElement, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($TupleElement, $.Cardinality.Many),
  null,
)
...
const TupleExprAlias: $.$expr_PathNode<$.TypeSet<$TupleExprAlias, $.Cardinality.Many>, null> = _.syntax.$PathNode(
  $.$toSet($TupleExprAlias, $.Cardinality.Many),
  null,
)
