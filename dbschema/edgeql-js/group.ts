...
const makeGroupingSet = (prefix: string) => <T extends SimpleGroupElements>(grps: T): { [k in keyof T]?: T[k] } => {
    ...
    $FreeObjectλShape & {
      ...
      key: LinkDesc<
        ObjectType<
          'std::FreeObject',
          {
            [k in keyof Mods['by']]: Mods['by'][k]['__element__'] extends ObjectType ? never
              : PropertyDesc<
