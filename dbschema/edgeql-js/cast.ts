...
import type { BaseType, Expression, ObjectTypeExpression, ScalarType, TypeSet } from './typesystem'

export function cast<Target extends BaseType | ObjectTypeExpression>(
  target: Target,
  arg: null,
): $expr_Cast<
  Target extends BaseType ? Target
    : Target extends ObjectTypeExpression ? Target['__element__']
    : never,
  Cardinality.Empty
>
...
export function cast<Target extends BaseType, Expr extends TypeSet>(
  ...
  Target,
  Cardinality extends Expr['__cardinality__'] ? Cardinality.One
